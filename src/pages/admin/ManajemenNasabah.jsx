...
// Komponen ManajemenNasabah.jsx
const ManajemenNasabah = () => {
    // State untuk mengontrol visibilitas modal
    const [isModalOpen, setIsModalOpen] = useState(false);
    // State untuk menentukan apakah modal dalam mode 'edit' atau 'tambah'
    const [modalMode, setModalMode] = useState('add');
    // State untuk menyimpan data nasabah yang akan diedit
                ...
                <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-6">
                    <div className="flex flex-col md:flex-row justify-between items-center mb-4 gap-4">
                        <div className="relative w-full md:w-1/3">
                            <input type="text" placeholder="Cari nama atau ID nasabah..." className="w-full pl-10 pr-4 py-2 border border-slate-300 rounded-lg bg-white focus:outline-none focus:ring-2 focus:ring-teal-500" />
